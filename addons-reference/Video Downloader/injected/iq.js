  ...
  if ((r && typeof r == "object") || typeof r == "function")
    for (let a of Re(r))
      !De.call(i, a) &&
        ...
        fe(i, a, {
          get: () => r[a],
          enumerable: !(e = Ie(r, a)) || e.enumerable,
        });
  return i;
};
var ce = (i, r, t) => (
...
var xe = ge((de, Ee) => {
  (function (i, r) {
    ...
    else if (typeof de < "u") r(Ee);
    else {
      var t = { exports: {} };
      (r(t), (i.browser = t.exports));
    }
  })(
    typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : de,
    function (i) {
      "use strict";
      if (
        !(
            ...
            let o = (m) =>
              ...
              u = (m, f) =>
                function (A, ...x) {
                  if (x.length < f.minArgs)
                    throw new Error(
                      `Expected at least ${f.minArgs} ${g(f.minArgs)} for ${m}(), got ${x.length}`,
                    );
                  if (x.length > f.maxArgs)
                    throw new Error(
                      `Expected at most ${f.maxArgs} ${g(f.maxArgs)} for ${m}(), got ${x.length}`,
                    );
                  return new Promise((M, P) => {
                    if (f.fallbackToNoCallback)
                      try {
                        A[m](...x, l({ resolve: M, reject: P }, f));
                      } catch (y) {
                        (console.warn(
                  ...
                  x = {
                    ...
                    get(P, y, N) {
                      ...
                      if (typeof b == "function")
                        if (typeof f[y] == "function") b = h(m, m[y], f[y]);
                        else if (_(c, y)) {
                          let V = u(y, c[y]);
                          b = h(m, m[y], V);
                        } else b = b.bind(m);
              ...
              D = (m, f, c, ...A) => {
                ...
                return new Promise((x, M) => {
                  let P = q.bind(null, { resolve: x, reject: M });
...
(function (i) {
  function r() {
    ...
    for (var o = [], l = 0, g = a; l < g.length; l++) {
      var u = g[l];
...
(function (i) {
  function r(l) {
    ...
    for (
      var h = l === void 0 ? [] : Array.isArray(l) ? l : L([l], g, !0),
        _ = [],
        S = 0,
        w = h;
      S < w.length;
  ...
  i.partition = n;
  function o(l) {
    return l instanceof E || l instanceof O;
  }
  i.isResult = o;
})(Y || (Y = {}));
...
function C(i) {
  ...
  if (Array.isArray(i))
    return { __serde_tag: "array", __serde_val: i.map((r) => C(r)) };
  ...
  if (i instanceof Headers) {
    ...
    if (i instanceof Set)
      return { __serde_tag: "set", __serde_val: [...i.values()].map(C) };
    if (i instanceof Map)
      return {
        __serde_tag: "map",
        __serde_val: [...i.entries()].map(([r, t]) => [C(r), C(t)]),
      };
...
var ne = ce(he()),
  Be = function (r) {
    return ne.default.atob
      ? ne.default.atob(r)
      : Buffer.from(r, "base64").toString("binary");
  };
function ae(i) {
  for (var r = Be(i), t = new Uint8Array(r.length), e = 0; e < r.length; e++)
    t[e] = r.charCodeAt(e);
  return t;
}
...
`)
      ...
      this.tagMappers
        ...
        .forEach((n) => {
          ...
          if (((t = /^#EXT-X-BYTERANGE:(.*)?$/.exec(n)), t)) {
            ((e = X(se(t[1]), { type: "tag", tagType: "byterange" })),
              this.trigger("data", e));
            return;
          }
          ...
          if (((t = /^#EXT-X-MAP:(.*)$/.exec(n)), t)) {
            if (((e = { type: "tag", tagType: "map" }), t[1])) {
              let o = I(t[1]);
              (o.URI && (e.uri = o.URI),
                o.BYTERANGE && (e.byterange = se(o.BYTERANGE)));
            }
            this.trigger("data", e);
            return;
          }
            ...
            ((e = { type: "tag", tagType: "stream-inf" }),
              t[1] &&
                ...
                e.attributes.RESOLUTION &&
                  (e.attributes.RESOLUTION = ye(e.attributes.RESOLUTION)),
          ...
          if (((t = /^#EXT-X-PART:(.*)$/.exec(n)), t && t[1])) {
            ((e = { type: "tag", tagType: "part" }),
              ...
              e.attributes.hasOwnProperty("BYTERANGE") &&
                (e.attributes.byterange = se(e.attributes.BYTERANGE)),
              this.trigger("data", e));
            return;
          }
  ...
  Ge = (i) => i.toLowerCase().replace(/-(\w)/g, (r) => r[1].toUpperCase()),
  k = function (i) {
    let r = {};
    return (
  ...
  oe = function (i) {
    ...
    (t &&
      ...
      e &&
        r[o] < g &&
        (this.trigger("warn", {
          message: `${a} clamping PART-HOLD-BACK (${r[o]}) to partTargetDuration * 2 (${g}).`,
        }),
        (r[o] = g)));
  },
  J = class extends Q {
    constructor(r = {}) {
      (super(),
        (this.lineStream = new ue()),
        (this.parseStream = new le()),
                ...
                ({
                        ...
                        (this.manifest.contentProtection["com.widevine.alpha"] =
                          {
                            ...
                            pssh: ae(s.attributes.URI.split(",")[1]),
                          }));
                      return;
                    }
                    (s.attributes.METHOD ||
                  ...
                  media() {
                    ...
                    ((p[s.attributes["GROUP-ID"]] =
                      ...
                      s.attributes["INSTREAM-ID"] &&
                        (D.instreamId = s.attributes["INSTREAM-ID"]),
                      s.attributes.CHARACTERISTICS &&
                        (D.characteristics = s.attributes.CHARACTERISTICS),
                      s.attributes.FORCED &&
                        (D.forced = /yes/i.test(s.attributes.FORCED)),
                      (q[s.attributes.NAME] = D));
                  },
                  discontinuity() {
                    ((_ += 1),
                      (a.discontinuity = !0),
                  ...
                  "preload-hint"() {
                    ...
                    if (
                      ...
                      for (let c = 0; c < a.preloadHints.length - 1; c++) {
                        let A = a.preloadHints[c];
                        A.type &&
                          A.type === d.type &&
                          this.trigger("warn", {
                  ...
                  daterange() {
                    ...
                    if (!v[d.id]) v[d.id] = d;
                      ...
                      for (let c in v[d.id])
                        if (
                          d[c] &&
                          JSON.stringify(v[d.id][c]) !== JSON.stringify(d[c])
                        ) {
                          this.trigger("warn", {
                            message:
...
var me = new BroadcastChannel(`injected-${Z(window.location.href)}`);
function be(i) {
  let r = B.FromTrustedInjectedToUntrusted;
  me.postMessage({ msg: i, channel: r });
}
function Te(i) {
  let r = (t) => {
    let e = t.data.msg;
  ...
  return (
    ...
    () => {
      me.removeEventListener("message", r);
    }
  );
}
var ve = ce(xe(), 1);
async function We(i, r) {
  await ve.default.runtime.sendMessage({ msg: i, channel: r });
}
function Se(i) {
...
function Ke(i) {
  if (!i) return T;
  for (let r of i) if ("m3u8" in r) return R(r.m3u8);
  return T;
}
async function Qe() {
  let r = (
      await new Promise((o) => {
        let l = Te((g) => {
          g.name == "iq_on_config" && (o(g.data.config), l());
        });
        be({ name: "iq_request_config", data: null });
      })
    ).__dash,
    t = Ke(r?.data?.program?.video);
  if (t.isNone()) return E("No M3U8 media found");
  let e = Ae(t.value);
  if (e.isErr()) return E("Error parsing manifest");
  let a = _e(e.value),
    n = {
      is_youtube: !1,
      has_drm: !1,
      sent_headers: new Headers(),
      initiator: ie(window.location.href),
      type: "m3u8",
      hash: `media_hash_${Z(t.value)}`,
      ...
      demuxer: "mp4",
      url: new URL(
        `data:text/plain;charset=UTF-8,${encodeURIComponent(t.value)}`,
      ),
      cache: "default",
    };
  return O(n);
