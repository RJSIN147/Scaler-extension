...
var K = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports);
var Z = (a, t, g, u) => {
  if ((t && typeof t == "object") || typeof t == "function")
    for (let x of q(t))
      !H.call(a, x) &&
        ...
        j(a, x, {
          get: () => t[x],
          enumerable: !(u = V(t, x)) || u.enumerable,
        });
  return a;
};
var J = (a, t, g) => (
  ...
  Z(
    t || !a || !a.__esModule
      ? j(g, "default", { value: a, enumerable: !0 })
      : g,
    a,
  )
);
var W = K((F, E) => {
  (function (a, t) {
    ...
    else if (typeof F < "u") t(E);
    else {
      var g = { exports: {} };
      (t(g), (a.browser = g.exports));
    }
  })(
        ...
        let t = "The message port closed before a response was received.",
          g = (u) => {
            ...
            let D = (e) =>
              ...
              B = {
                devtools: { network: { onRequestFinished: w(O) } },
                runtime: {
                  onMessage: w(P),
                  onMessageExternal: w(P),
...
async function G(a, t) {
  await S.default.runtime.sendMessage({ msg: a, channel: t });
}
function L(a) {
  let t = p.FromInjectedToService;
  G(a, t);
}
function R(a) {
  let t = (g) => {
    g.channel == p.FromServiceToInjected && a(g.msg);
  };
  return (
    S.default.runtime.onMessage.addListener(t),
    () => {
      S.default.runtime.onMessage.removeListener(t);
    }
  );
}
function Q(a) {
  L({ name: "on_activate_addon", data: { key: a.detail.message } });
}
(async () => {
  ...
  let a = R(async (t) => {
    (document.dispatchEvent(new CustomEvent(t.name, { detail: t.data })), a());
  });
})();
