...
// Log when background script loads (check Service Worker console at chrome://extensions)
// console.log("[Scaler++ Background] Service worker initialized");

chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  // console.log("[Scaler++ Background] Received message:", request);

  if (request.action === "searchLeetCodeProblem") {
    // console.log("[Scaler++ Background] Handling search for:", request.title);
    handleSearch(request.title)
      .then((result) => {
        // console.log("[Scaler++ Background] Search result:", result);
        sendResponse(result);
      })
      .catch((error) => {
        console.error("[Scaler++ Background] Search error:", error);
