...
var ve = (e, r, t) => (
  ...
  un(
    r || !e || !e.__esModule
      ? Cr(t, "default", { value: e, enumerable: !0 })
      : t,
    e,
  )
);
var Ir = te((ur, Br) => {
  (function (e, r) {
    ...
    typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : ur,
    function (e) {
      "use strict";
      if (
        !(
                      ...
                      let Y = (re) => {
                        re.then(
                          ...
                          (_) => {
                            let U;
                            (_ &&
                            (_ instanceof Error || typeof _.message == "string")
                              ? (U = _.message)
...
var yr = te((ue) => {
  ...
  function Gr(e) {
    if (!e) return [];
    var r = wn(e);
    return Object.keys(r.reduce(Sn, {}));
  }
  function xn(e) {
    return function (r) {
  ...
  function Nn(e, r, t) {
    ...
    n === Se.XMLNS && (r._nsMap[t.prefix ? t.localName : ""] = t.value);
  }
  function at(e, r, t, n) {
    e && e._inc++;
    var u = t.namespaceURI;
    u === Se.XMLNS && delete r._nsMap[t.prefix ? t.localName : ""];
  }
  function pr(e, r, t) {
    if (e && e._inc) {
      e._inc++;
  ...
  function Bn(e) {
    return (
      e &&
      (e.nodeType === S.DOCUMENT_NODE ||
        e.nodeType === S.DOCUMENT_FRAGMENT_NODE ||
        e.nodeType === S.ELEMENT_NODE)
    );
  }
  function In(e) {
    return (
      ...
      (Q(e) ||
        ...
        ee(e) ||
        e.nodeType === S.DOCUMENT_FRAGMENT_NODE ||
        e.nodeType === S.COMMENT_NODE ||
        e.nodeType === S.PROCESSING_INSTRUCTION_NODE)
    );
  }
  function ee(e) {
    return e && e.nodeType === S.DOCUMENT_TYPE_NODE;
  }
  function Q(e) {
    return e && e.nodeType === S.ELEMENT_NODE;
  }
  function dr(e) {
    return e && e.nodeType === S.TEXT_NODE;
  }
  function jr(e, r) {
    var t = e.childNodes || [];
    if (J(t, Q) || ee(r)) return !1;
    var n = J(t, ee);
  ...
  function On(e, r, t) {
    ...
    if (!In(r) || (ee(r) && e.nodeType !== S.DOCUMENT_NODE))
      throw new N(
        G,
  ...
  function Rn(e, r, t) {
    var n = e.childNodes || [],
      u = r.childNodes || [];
    if (r.nodeType === S.DOCUMENT_FRAGMENT_NODE) {
      var i = u.filter(Q);
      if (i.length > 1 || J(u, dr))
        throw new N(G, "More than one element or text in fragment");
    ...
    if (Q(r) && !jr(e, t))
      throw new N(G, "Only one element can be added and only after doctype");
    if (ee(r)) {
      if (J(n, ee)) throw new N(G, "Only one doctype is allowed");
      var a = J(n, Q);
      if (t && n.indexOf(a) < n.indexOf(t))
        throw new N(G, "Doctype can only be inserted before an element");
      if (!t && a)
        throw new N(G, "Doctype can not be appended since element is present");
    }
  }
  function lt(e, r, t) {
    var n = e.childNodes || [],
    ...
    if (ee(r)) {
      ...
      var s = l;
      if (J(n, l)) throw new N(G, "Only one doctype is allowed");
      var a = J(n, Q);
      if (t && n.indexOf(a) < n.indexOf(t))
        throw new N(G, "Doctype can only be inserted before an element");
    }
  ...
  function je(e, r, t, n) {
    (On(e, r, t), e.nodeType === S.DOCUMENT_NODE && (n || Rn)(e, r, t));
    var u = r.parentNode;
    ...
    getElementById: function (e) {
      ...
      return (
        xe(this.documentElement, function (t) {
          if (t.nodeType == j && t.getAttribute("id") == e)
            return ((r = t), !0);
        }),
        r
      );
  ...
  Te.prototype.getElementsByTagName = oe.prototype.getElementsByTagName;
  Te.prototype.getElementsByTagNameNS = oe.prototype.getElementsByTagNameNS;
  H(oe, S);
  function Ye() {}
  ...
  H(gr, Ne);
  function hr() {}
  hr.prototype = { nodeName: "#cdata-section", nodeType: Qr };
  H(hr, Ne);
  function Xe() {}
  Xe.prototype.nodeType = tt;
  H(Xe, S);
  function ct() {}
  ct.prototype.nodeType = Tn;
  H(ct, S);
  function mt() {}
  mt.prototype.nodeType = Cn;
  H(mt, S);
  function Ar() {}
  Ar.prototype.nodeType = Zr;
  H(Ar, S);
  function Je() {}
  Je.prototype.nodeName = "#document-fragment";
  Je.prototype.nodeType = K;
  H(Je, S);
  function Dr() {}
  ...
  function Xr(e, r, t) {
    var n = e.prefix || "",
      u = e.namespaceURI;
    if (!u || (n === "xml" && u === Se.XML) || u === Se.XMLNS) return !1;
    ...
    switch (e.nodeType) {
      case j:
        ...
        for (var h = 0; h < a; h++) {
          ...
          g.prefix == "xmlns"
            ...
            : g.nodeName == "xmlns" &&
              u.push({ prefix: "", namespace: g.value });
        }
        for (var h = 0; h < a; h++) {
          var g = i.item(h);
          if (Xr(g, t, u)) {
            var D = g.prefix || "",
              y = g.namespaceURI;
            (lr(r, D ? "xmlns:" + D : "xmlns", y),
              u.push({ prefix: D, namespace: y }));
          }
          ce(g, r, t, n, u);
        }
        if (s === l && Xr(e, t, u)) {
        ...
        if (b || (t && !/^(?:meta|link|img|br|hr|input)$/i.test(s))) {
          if ((r.push(">"), t && /^script$/i.test(s)))
            for (; b; )
              (b.data ? r.push(b.data) : ce(b, r, t, n, u.slice()),
                (b = b.nextSibling));
      ...
      case K:
        for (var b = e.firstChild; b; )
          (ce(b, r, t, n, u.slice()), (b = b.nextSibling));
        return;
      case me:
      ...
      case tt:
        ...
        if ((r.push("<!DOCTYPE ", e.name), O))
          (r.push(" PUBLIC ", O), w && w != "." && r.push(" ", w), r.push(">"));
        else if (w && w != ".") r.push(" SYSTEM ", w, ">");
        else {
  ...
  function ft(e, r, t) {
    ...
    if (
      ...
      for (var u = r.firstChild; u; )
        (n.appendChild(ft(e, u, t)), (u = u.nextSibling));
    return n;
  }
  function cr(e, r, t) {
    ...
    switch (
      (r.childNodes && (n.childNodes = new Z()),
      (n.ownerDocument = e),
      n.nodeType)
    ) {
      case j:
    ...
    if (t)
      for (var c = r.firstChild; c; )
        (n.appendChild(cr(e, c, t)), (c = c.nextSibling));
    return n;
  }
  function gt(e, r, t) {
    e[r] = t;
        ...
        switch (r.nodeType) {
          ...
          case K:
            ...
            for (r = r.firstChild; r; )
              (r.nodeType !== 7 && r.nodeType !== 8 && t.push(e(r)),
                (r = r.nextSibling));
            return t.join("");
          default:
            return r.nodeValue;
          ...
          set: function (r) {
            switch (this.nodeType) {
              ...
              case K:
                ...
                (r || String(r)) &&
                  this.appendChild(this.ownerDocument.createTextNode(r));
                break;
              default:
...
var St = te((Er) => {
  var Fe = we().NAMESPACE,
    ...
    yt = new RegExp(
      "^" + vr.source + Dt.source + "*(?::" + vr.source + Dt.source + "*)?$",
    ),
    Ie = 0,
    ie = 1,
    de = 2,
  ...
  function Ln(e, r, t, n, u) {
    ...
    function l(_, U) {
      for (; _ >= c && (U = m.exec(e)); )
        ((o = U.index), (c = o + U[0].length), d.lineNumber++);
    ...
    for (
      ...
      try {
        ...
        switch ((y > D && s(y), e.charAt(y + 1))) {
          case "/":
            var A = e.indexOf(">", y + 3),
              w = e.substring(y + 2, A).replace(/[ \t\n\r]+$/g, ""),
              p = h.pop();
            A < 0
              ? ((w = e.substring(y + 2).replace(/[\s<].*/, "")),
                u.error("end tag name: " + w + " is not complete:" + p.tagName),
                (A = y + 1 + w.length))
              : w.match(/\s</) &&
                ((w = w.replace(/[\s<].*/, "")),
                u.error("end tag name: " + w + " maybe not complete"),
                (A = y + 1 + w.length));
            var f = p.localNSMap,
              v = p.tagName == w,
              E =
                v || (p.tagName && p.tagName.toLowerCase() == w.toLowerCase());
            if (E) {
              if ((n.endElement(p.uri, p.localName, w), f))
                for (var B in f)
                  Object.prototype.hasOwnProperty.call(f, B) &&
                    n.endPrefixMapping(B);
              v ||
                u.fatalError(
                  "end tag name: " +
                    w +
          ...
          default:
            ...
            Fe.isHTML(x.uri) && !x.closed
              ? (A = Un(e, A, x.tagName, a, n))
              : A++;
        }
      } catch (_) {
  ...
  Me.prototype = {
    ...
    startElement: function (e, r, t, n) {
      ...
      (Ze(this, i),
        ...
        this.locator && Ae(this.locator, i));
      for (var s = 0; s < a; s++) {
        var e = n.getURI(s),
          l = n.getValue(s),
          t = n.getQName(s),
    ...
    characters: function (e, r, t) {
      if (((e = Tt.apply(this, arguments)), e)) {
    ...
    startDTD: function (e, r, t) {
      ...
      if (n && n.createDocumentType) {
        ...
        (this.locator && Ae(this.locator, u),
          Ze(this, u),
          (this.doc.doctype = u));
      }
    },
...
(function (e) {
  function r(s) {
    ...
    for (
      var c = s === void 0 ? [] : Array.isArray(s) ? s : ae([s], l, !0),
        m = [],
        d = 0,
        h = c;
      d < h.length;
...
function X(e) {
  ...
  if (Array.isArray(e))
    return { __serde_tag: "array", __serde_val: e.map((r) => X(r)) };
  ...
  if (e instanceof Headers) {
    ...
    if (e instanceof Set)
      return { __serde_tag: "set", __serde_val: [...e.values()].map(X) };
    if (e instanceof Map)
      return {
        __serde_tag: "map",
...
var Mt = (e) => !!e && typeof e == "object",
  ...
  Jn = (e, r) => e.reduce((t, n, u) => (n[r] && t.push(u), t), []),
  Qn = (e, r) =>
    Gt(
      e.reduce(
        (t, n) => (
  ...
  Zn = (e) => {
    ...
    return (
      typeof e.offset == "bigint" || typeof e.length == "bigint"
        ? (r =
            V.default.BigInt(e.offset) +
            V.default.BigInt(e.length) -
            V.default.BigInt(1))
  ...
  ru = (e, r, t) => {
    ...
    for (let y = 0; y < o.length; y++) {
      let b = r.references[y],
        O = b.referencedSize,
        w = b.subsegmentDuration,
        p;
      typeof D == "bigint"
        ? (p = D + V.default.BigInt(O) - V.default.BigInt(1))
        : (p = D + O - 1);
      let f = `${D}-${p}`,
        E = Wt({
          baseUrl: t,
  ...
  br = (e) => {
    ...
    return (
      ...
      t.map(
        (n) => (
          (n.discontinuityStarts = Jn(n.segments || [], "discontinuity")),
          n
        ),
      )
    );
  ...
  yu = ({
    ...
    let D = g.playlists.length === 0,
      ...
      w = O.map(({ timelineStarts: p }) => p);
    return (
      (g.timelineStarts = $t(w)),
  ...
  jt = (e, r) => {
    ...
    for (let m = 0; m < r.length; m++) {
      ...
      let b = s + o.length + y,
        O = s + o.length;
      for (; O < b; )
        (o.push({ number: O, duration: h / a, time: c, timeline: l }),
          (c += h),
          O++);
    }
    return o;
  ...
  Cu = ({ attributes: e, segmentInfo: r }) => {
    let t, n;
    r.template
      ? ((n = wu), (t = M(e, r.template)))
      : r.base
        ? ((n = Wt), (t = M(e, r.base)))
  ...
  Tu = (e) => e.map(Cu),
  C = (e, r) => Ht(e.childNodes).filter(({ tagName: t }) => t === r),
  ...
  rr = (e, r) =>
    r.length
      ...
      : e,
  xr = (e) => {
    let r = C(e, "SegmentTemplate")[0],
      t = C(e, "SegmentList")[0],
      n = t && C(t, "SegmentURL").map((m) => M({ tag: "SegmentURL" }, R(m))),
      u = C(e, "SegmentBase")[0],
      i = t || r,
      a = i && C(i, "SegmentTimeline")[0],
      s = t || u || r,
      l = s && C(s, "Initialization")[0],
      o = r && R(r);
    o && l
    ...
    let c = {
      template: o,
      segmentTimeline: a && C(a, "S").map((m) => R(m)),
  ...
  Mu = (e) =>
    ye(
      C(e.node, "EventStream").map((r) => {
        let t = R(r),
          n = t.schemeIdUri;
        return C(r, "Event").map((u) => {
          let i = R(u),
  ...
  qu = (e, r = {}) => {
    ...
    let s = C(e, "Location"),
      l = R(e),
      o = rr([{ baseUrl: t }], C(e, "BaseURL")),
      c = C(e, "ContentSteering");
  ...
  for (let u of t) {
    ...
    let [a, s] = i.value,
      o = {
        ...
        prefered_entry: T,
        duration: s,
        initiator: Tr(window.location.href),
